...
class MyStatelessWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        children: <Widget>[
          Text('#News', style: Theme.of(context).textTheme.headline3),
          Expanded(
            child: Container(
              child: const Center(
                child: ListTile(
                  title: Text(
                      'Space x:l essai du prototype "Starship" se conduit par un crash',
                      style: TextStyle(fontWeight: FontWeight.bold)),
                  subtitle:
                      Text('Publie aujourd"hui a10h07,mis a jour a 11h02'),
                ),
              ),
            ),
          ),
              ...
              child: const Center(
                child: ListTile(
                  title: Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold)),
                  subtitle: Text('Publie aujourdhui a 00h00  , Catherine Mary'),
                ),
              ),
            ),
          ),
              ...
              child: const Center(
                child: ListTile(
                  title: Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold)),
                  subtitle: Text('Publie le mardi 10h00,mis a jour a 10h33'),
                ),
              ),
            ),
          ),
